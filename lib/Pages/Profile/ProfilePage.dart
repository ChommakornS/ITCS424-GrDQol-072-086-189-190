...
class ProfilePage extends StatelessWidget {
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.connectionState == ConnectionState.waiting) {
                              ...
                              if (snapshot.hasError) {
                                ...
                                // Retrieve the username from the snapshot
                                String? username = snapshot.data?.get('username');
                                return Column(
                                  children: [
                                    _buildEmailBox(_width, email ?? '', username ?? 'Unknown Username'),
                                    SizedBox(height: _height / 20),
                                    ElevatedButton(
                                      onPressed: () {
                                        // Show confirmation dialog when logout button is pressed
  ...
  Widget _buildEmailBox(double width, String email, String username) => Container(
    padding: EdgeInsets.symmetric(horizontal: width / 20, vertical: 20.0),
    decoration: BoxDecoration(
      color: Colors.white,
      borderRadius: BorderRadius.circular(10.0),
      border: Border.all(color: Colors.black, width: 1.0),
